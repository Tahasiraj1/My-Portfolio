  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        shine:
          "text-primary-foreground animate-shine bg-gradient-to-r from-emerald-600 via-cyan-600 to-emerald-700 bg-[length:400%_100%] ",
        gooeyRight:
        ...
        linkHover2:
          "relative after:absolute after:bg-white after:bottom-2 after:h-[3px] after:w-2/3 after:origin-bottom-right after:scale-x-0 hover:after:origin-bottom-left hover:after:scale-x-100 after:transition-transform after:ease-in-out after:duration-300",
      },
      size: {
