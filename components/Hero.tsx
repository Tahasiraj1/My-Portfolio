      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div
            ...
            animate="visible"
          >
            <Link href="\TahaSirajResume.pdf" download={true}>
              <Button
                className="font-bold text-lg rounded-full relative overflow-hidden bg-emerald-950 hover:bg-emerald-950 border-2 border-emerald-600/[0.15] shadow-[0_8px_32px_0_rgba(16,185,129,0.2)] after:absolute after:inset-0 after:bg-[radial-gradient(circle_at_50%_50%,rgba(16,185,129,0.2),rgba(0,0,0,0.3)_50%,rgba(0,0,0,0.6)_100%)] transition-transform duration-300 p-6 items-center justify-center group"
              >
                {/* Shining gradient overlay */}
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 ease-in-out" />
                <span className="relative z-10 flex items-center justify-center">Download Resume <Download className="ml-2 h-5 w-5 text-white" /></span>
              </Button>
            </Link>
          </motion.div>
        </div>
