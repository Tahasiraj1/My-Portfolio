...
export function MorphingDialogBasicTwo() {
  return (
    <>
      ...
      <div className="flex items-start justify-center px-10 py-10 w-full">
...
function ProjectCard({ project }: { project: Project }) {
  return (
    ...
    >
      <div className="flex flex-col items-start space-y-3">
        <MorphingDialogTrigger>
          <MorphingDialogImage
            ...
            alt={project.title}
            className="h-[250px] w-auto object-top rounded-xl"
          />
          <div className="mt-3">
      ...
      <MorphingDialogContainer className="relative h-auto max-w-full">
        <MorphingDialogContent className="h-auto w-full overflow-hidden bg-black/90 backdrop-blur-lg border border-slate-700/40 relative mx-10 rounded-xl">
          <ScrollArea className="h-full w-full" type="scroll">
            <div className="relative p-6 flex h-full w-full">
              <div className="flex flex-1 w-auto h-auto justify-center">
                <ProjetCarousel
              ...
              <div className="flex flex-col max-w-xl ml-6 items-start justify-center">
                <MorphingDialogTitle className="text-white">
                  {project.title}
                </MorphingDialogTitle>
                <MorphingDialogSubtitle className="font-light text-gray-100">
                  {project.description}
                </MorphingDialogSubtitle>
